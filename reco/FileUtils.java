...
public class FileUtils
{
  ...
  private static final String TRAINING_DIR = "savedFaces/users";

  private static final String EF_CACHE = "eigen.cache";

  private static final String EIGENFACES_DIR = "savedFaces/eigenfaces";
  private static final String EIGENFACES_PREFIX = "eigen_";

  private static final String RECON_DIR = "savedFaces/reconstructed";
